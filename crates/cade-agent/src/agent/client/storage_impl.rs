...
impl StorageBackend for HttpTransport {
    ...
    async fn upsert_memory_with_limit(
        ...
        self.upsert_memory_with_limit(agent_id, label, value, desc, limit)
            .await
    }
    ...
    async fn archival_memory_insert(
        ...
        self.insert_archival_memory(agent_id, content, &tag_vec)
            .await
    }
    ...
    async fn archival_memory_search(
        ...
        let results = self
            .search_archival_memory(agent_id, keyword, limit.unwrap_or(10))
            .await?;
        Ok(results)
    }
    ...
    async fn add_memory_evidence(
        ...
        self.add_memory_evidence(agent_id, label, kind, reference, excerpt)
            .await
    }
    ...
    async fn store_artifact(
        ...
        self.store_artifact(agent_id, kind, content_type, text, None, None)
            .await
    }
    ...
    async fn install_skill(
        ...
        Err(crate::Error::custom(
            "install_skill not implemented on HttpTransport",
        ))
    }
    ...
    async fn run_skill_script(
        ...
        Err(crate::Error::custom(
            "run_skill_script not implemented on HttpTransport",
        ))
    }
    ...
    async fn load_skill_ref(
        ...
        Err(crate::Error::custom(
            "load_skill_ref not implemented on HttpTransport",
        ))
    }
    ...
    async fn create_checkpoint(
        ...
        self.create_checkpoint(agent_id, label, desc, conversation_id, git_commit_hash)
            .await
    }
    ...
    async fn message_agent(
        ...
        Err(crate::Error::custom(
            "message_agent not supported over HTTP yet",
        ))
    }
