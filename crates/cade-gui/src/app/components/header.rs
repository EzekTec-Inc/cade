...
pub fn render(
    ...
    egui::Panel::top("dashboard_header")
        .frame(frame)
        .show_inside(ui, |ui| {
            ui.horizontal(|ui| {
                // Left side
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    if ui.add(btn).clicked() {
                        action = Some(crate::app::AppAction::ExecutePaletteCommand(String::from(
                            "/pricing",
                        )));
                    }
                    ...
                    if ui
                        .add(
                            egui::Label::new(
                                egui::RichText::new("Manage LLM keys")
                                    .color(link_color)
                                    .size(13.0),
                            )
                        ...
                        .clicked()
                    {
                        ui.ctx().open_url(egui::OpenUrl::new_tab(
                            "https://github.com/EzekTec-Inc/CADE/blob/master/docs/api.md",
                        ));
                    }
                    ui.add_space(12.0);
                    if ui
                        .add(
                            egui::Label::new(
                                egui::RichText::new("Docs").color(link_color).size(13.0),
                            )
                            .sense(egui::Sense::click()),
                        )
                        .clicked()
                    {
                        ui.ctx().open_url(egui::OpenUrl::new_tab(
                            "https://github.com/EzekTec-Inc/CADE/tree/master/docs",
                        ));
                    }
                    ui.add_space(12.0);
                    if ui
                        .add(
                            egui::Label::new(
                                egui::RichText::new("Support").color(link_color).size(13.0),
                            )
                            .sense(egui::Sense::click()),
                        )
                        .clicked()
                    {
                        ui.ctx().open_url(egui::OpenUrl::new_tab(
                            "https://github.com/EzekTec-Inc/CADE/issues",
                        ));
                    }
                });
            });
