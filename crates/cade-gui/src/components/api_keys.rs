    ...
    rsx! {
        div { class: "flex-1 bg-[#040711] h-full overflow-y-auto select-text",
            header { class: "px-10 py-4 flex items-center justify-between select-none border-b border-[#1e293b]/70",
                h1 { class: "text-lg font-semibold text-slate-100", "API Keys" }
            }
            div { class: "p-10",
                div { class: "bg-[#090d16] border border-[#1e293b] rounded-xl p-8 max-w-lg",
                    h2 { class: "text-slate-100 font-semibold text-sm mb-4", "Server Authentication" }
                    ...
                    div { class: "bg-[#1f212a] border border-[#1e293b] rounded-lg p-3",
                        div { class: "text-[10px] font-bold text-slate-500 tracking-wider uppercase mb-1", "Current Key" }
                        span { class: "text-slate-300 text-sm font-mono", "{masked}" }
                    }
