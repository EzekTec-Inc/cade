...
pub fn pricing_for_model(model_id: &str) -> ModelPricing {
    match model_id {
        ...
        m if m.contains("claude-haiku-4") || m.contains("claude-3-5-haiku") => ModelPricing {
            input: 0.80,
            output: 4.00,
            cache_read: 0.08,
            cache_write: 1.00,
        },
        m if m.contains("claude-opus-4") || m.contains("claude-3-opus") => ModelPricing {
            input: 15.00,
            output: 75.00,
            cache_read: 1.50,
            cache_write: 18.75,
        ...
        // -- OpenAI
        m if m.contains("gpt-4.1") && !m.contains("mini") => ModelPricing {
            input: 2.00,
            output: 8.00,
            cache_read: 0.50,
            cache_write: 0.0,
        ...
        m if m.contains("o4-mini") || m.contains("o3-mini") => ModelPricing {
            input: 1.10,
            output: 4.40,
            cache_read: 0.275,
            cache_write: 0.0,
        },
        m if m.contains("/o3") && !m.contains("mini") => ModelPricing {
            input: 10.00,
            output: 40.00,
            cache_read: 2.50,
            cache_write: 0.0,
        ...
        m if m.contains("gemini-2.0-flash") || m.contains("gemini-1.5-flash") => ModelPricing {
            input: 0.10,
            output: 0.40,
            cache_read: 0.025,
            cache_write: 0.0,
        ...
        m if m.starts_with("anthropic/") => ModelPricing {
            input: 3.00,
            output: 15.00,
            cache_read: 0.30,
            cache_write: 3.75,
        },
        m if m.starts_with("openai/") => ModelPricing {
            input: 2.50,
            output: 10.00,
            cache_read: 1.25,
            cache_write: 0.0,
        },
        m if m.starts_with("gemini/") || m.starts_with("gemini-") => ModelPricing {
            input: 1.25,
            output: 10.00,
            cache_read: 0.31,
            cache_write: 0.0,
