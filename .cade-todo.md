...
The user is asking how to implement the `AgentshBackend` (zero-bloat) integration path I proposed.
I will formulate the response directly without making any further tool calls.