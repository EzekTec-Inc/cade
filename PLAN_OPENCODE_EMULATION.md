...
*   [x] **Step 1.1: Introduce State Signals**
...
*   [x] **Step 1.2: Refactor Components to Render on Signal Fire**
...
*   [x] **Step 2.1: Integrated Javascript Runtime (rquickjs)**
...
*   [x] **Step 3.1: Context-Driven Dynamic Querying**
    *   Enhance CADE's `ToolContext` trait in `crates/cade-core/src/capabilities/` or `crates/cade-agent/src/tools/traits.rs` to expose an async callback:
        ...
        ```
*   [x] **Step 3.2: TUI Future Interceptor & Modal Prompt**
...
*   [x] **Step 3.3: Dynamic Bash Command Interception**
